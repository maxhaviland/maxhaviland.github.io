...
declare type DeepThemeExtension<ThemeObject, TypeHints> = {
    [Key in keyof ThemeObject]?: Omit<DeepThemeExtension<ThemeObject[Key], TypeHints>, keyof TypeHints> | (ThemeObject[Key] extends (...args: any[]) => any ? Partial<ReturnType<ThemeObject[Key]>> : Partial<ThemeObject[Key]>) | Record<string, any>;
} & Partial<TypeHints>;
